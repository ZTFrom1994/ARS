...
<html >
  ...
  <body>
     <div class="box box-solid">
            ...
            <div class="box-body">
              <table id="table_audit_daily_reimbursement" class="table table-bordered ">
                <thead>
                ...
                <tbody> 
              			<c:forEach var="item" items="${dailyReimbursements}">
	              			<tr>
				                  <td>#DBX${item.id}</td>
            ...
            <div class="box-footer" >
				<button type="submit" disabled="disabled" class="btn btn-primary pull-right" id="btn_daily_submit" style="margin-right:40px">
					提交已选
				</button>
			</div>
          </div>
        ...
        <script src="./pages_assessor/js/reser_daily_reimbursement.js"></script>
  </body>
</html>
